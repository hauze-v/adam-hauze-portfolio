          ...
          <section className="mb-10">
            ...
            <div className="lg:flex gap-10">
              ...
              <div className="text-center shadow-lg p-10 rounded-xl my-10 dark:bg-slate-700 dark:shadow-none flex-1">
                ...
                <h3 className="text-lg font-medium pt-8 pb-2 lg:text-2xl dark:text-white">Software Development</h3>
              ...
              <div className="text-center shadow-lg p-10 rounded-xl my-10 dark:bg-slate-700 dark:shadow-none flex-1">
                ...
                <p className="text-gray-800 dark:text-gray-300 py-1 leading-5">API Integration</p>
        ...
        <footer className="bg-white dark:bg-gray-900">
          <div className="mx-auto max-w-7xl overflow-hidden px-6 py-10 sm:py-24 lg:px-8">
            <div className="mt-16 flex justify-center gap-x-10">
              <a href="#" className="text-gray-600 dark:text-gray-400 hover:text-gray-800 dark:hover:text-gray-600" target="_blank">
